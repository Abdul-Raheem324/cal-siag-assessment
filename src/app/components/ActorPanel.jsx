            ...
            >
              ...
              <div className="flex-1 px-3 py-2 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="font-mono text-[10px] font-semibold text-ink-0">
                    {actor.name}
                  </span>
                  <span
                  ...
                  <span className="font-mono text-[8px] text-ink-3 ml-auto">
                    {actor.country}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[9px] text-ink-2 truncate">
                    {actor.full_name}
                  </span>
                  <span className="font-mono text-[8px] text-ink-3 shrink-0 ml-2">
                    {actor.event_count || 0} ev
                  </span>
                </div>
              </div>
              {/* Threat pill */}
