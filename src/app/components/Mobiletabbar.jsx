            ...
            {MORE_NAV.map((item) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: active ? "rgba(77,148,255,0.1)" : "transparent",
                  }}
                  onMouseEnter={(e) => {
                    if (!active)
                      e.currentTarget.style.background = "rgba(46,61,88,0.5)";
                  }}
                  onMouseLeave={(e) => {
                    if (!active)
            ...
            >
              ...
              <Icon
                style={{
                  ...
                  color: active ? "#4d94ff" : "#627a9e",
                  filter: active
                    ? "drop-shadow(0 0 5px rgba(77,148,255,0.55))"
                    : "none",
                  transform: active ? "scale(1.1)" : "scale(1)",
                  transition: "all 0.2s",
                }}
