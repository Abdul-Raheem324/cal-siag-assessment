        ...
        >
          ...
          <div className="space-y-3">
            {[
              ...
              {
                label: "Corroboration",
                detail: `${event.corroboration_count || 0} independent source(s)`,
                val: corr,
                color: "#2ecc8e",
                weight: "20%",
              },
              ...
              <div key={row.label}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-[11px]" style={{ color: "#adbedd" }}>
                    {row.label}{" "}
                    <span style={{ color: "#5d7599" }}>({row.weight})</span>
                  </span>
                  <span
                ...
                <p className="text-[10px]" style={{ color: "#5d7599" }}>
                  {row.detail}
                </p>
              </div>
            ))}
