...
const DOMAIN = {
  military: {
    color: "#ff5370",
    bg: "rgba(255,83,112,0.14)",
    border: "rgba(255,83,112,0.3)",
  },
  political: {
    color: "#4d94ff",
    bg: "rgba(77,148,255,0.14)",
  ...
  cyber: {
    color: "#3ddcff",
    bg: "rgba(61,220,255,0.12)",
    border: "rgba(61,220,255,0.28)",
  },
  economic: {
    color: "#ffaa3b",
    bg: "rgba(255,170,59,0.14)",
...
export function DomainBadge({ domain }) {
  const d = DOMAIN[domain] || {
    color: "#adbedd",
    bg: "rgba(45,59,82,0.6)",
    border: "rgba(46,61,88,0.8)",
  };
  return (
    <span
...
export function ThreatBadge({ level }) {
  const MAP = {
    CRITICAL: {
      color: "#ff5370",
      bg: "rgba(255,83,112,0.15)",
      border: "rgba(255,83,112,0.35)",
    },
    HIGH: {
      color: "#ffaa3b",
      bg: "rgba(255,170,59,0.15)",
