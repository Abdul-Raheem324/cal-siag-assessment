...
export function StatCard({ label, value, sub, icon, accentColor = '#4d94ff', delay = 0 }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-start justify-between relative">
        <div>
          <p className="text-[11px] uppercase tracking-wider mb-2" style={{ color: '#627a9e' }}>{label}</p>
          <p className="text-2xl font-bold font-mono" style={{ color: accentColor }}>{value}</p>
          <p className="text-[11px] mt-1.5" style={{ color: '#627a9e' }}>{sub}</p>
        </div>
        <span
