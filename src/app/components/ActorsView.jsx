...
export default function ActorsView({ actors, relations }) {
  ...
  const selectedRelations = selected
    ? relations.filter(
        (r) => r.actor_1 === selected.name || r.actor_2 === selected.name,
      )
    : [];
  ...
  return (
    <div className="space-y-4">
      ...
      <SectionCard noPad className="animate-fade-in-up">
        ...
        <div
          className="flex items-center gap-4 px-4 py-3 border-t flex-wrap"
        ...
        >
          <SectionCard noPad>
            <SectionHeader
              ...
              subtitle={`${actors.length} actors monitored`}
            />
              ...
              {actors.map((actor, i) => {
                ...
                return (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (!isSel) e.currentTarget.style.background = "#1f2840";
                    }}
                    onMouseLeave={(e) => {
                      if (!isSel)
                  ...
                  >
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-[10px]" style={{ color: "#627a9e" }}>
                        events
                      </p>
                    </div>

                    <div
                      className="text-xs capitalize shrink-0 hidden sm:block w-20"
                      style={{ color: "#627a9e" }}
                    >
                      {actor.country}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1.5">
                      {selectedRelations.slice(0, 6).map((r, i) => {
                        const other =
                          r.actor_1 === selected.name ? r.actor_2 : r.actor_1;
                        return (
                          <div
                            key={i}
