...
// const THREAT_COLORS = {
//   CRITICAL: { text: '#ff5370', bg: 'rgba(255,83,112,0.12)', border: 'rgba(255,83,112,0.32)' },
//   HIGH:     { text: '#ffaa3b', bg: 'rgba(255,170,59,0.12)',  border: 'rgba(255,170,59,0.32)'  },
//   ELEVATED: { text: '#ffd166', bg: 'rgba(255,209,102,0.1)',  border: 'rgba(255,209,102,0.28)' },
//   LOW:      { text: '#2ecc8e', bg: 'rgba(46,204,142,0.1)',   border: 'rgba(46,204,142,0.28)'  },
// };

// /* Desktop sidebar — hidden on mobile, shown md+ as a fixed-width column */
...
//           </div>
//           <div>
//             <p className="text-sm font-bold leading-none" style={{ color: '#f1f5ff' }}>SAIG</p>
//             <p className="text-[10px] mt-0.5 leading-none" style={{ color: '#627a9e' }}>Conflict Monitor</p>
//           </div>
//         </div>
//       </div>
...
//         <p className="text-[10px] uppercase tracking-widest mb-2" style={{ color: '#627a9e' }}>
//           Threat Level
//         </p>
//         <div
...
//               )}
//               {active && (
//                 <span className="absolute left-0 top-2.5 bottom-2.5 w-0.5 rounded-r-full"
//                   style={{ background: 'linear-gradient(180deg,#4d94ff,#b880ff)' }} />
//               )}
//               <Icon
...
//       {/* Footer stats */}
//       <div className="px-4 py-3 border-t space-y-2" style={{ borderColor: '#2e3d58' }}>
//         <MiniStat label="Total Events"       value={stats?.totalEvents     ?? '—'} color="#adbedd" />
//         <MiniStat label="Escalation Signals" value={stats?.escalationCount ?? '—'} color="#ffaa3b" />
//         <MiniStat label="Avg Severity"       value={stats?.avgSeverity     ?? '—'} color="#ff5370" />
//       </div>
//     </aside>
//   );
// }
...
export default function Sidebar({ activeView, onViewChange, stats }) {
  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-4 border-b" style={{ borderColor: '#2e3d58' }}>
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0"
            style={{ background: 'linear-gradient(135deg, #4d94ff, #b880ff)', boxShadow: '0 0 14px rgba(77,148,255,0.35)' }}>
            <span className="text-white text-xs font-bold">S</span>
          </div>
          <div>
            <p className="text-sm font-bold leading-none" style={{ color: '#f1f5ff' }}>SAIG</p>
      ...
      {/* Threat level */}
      <div className="px-4 py-3 border-b" style={{ borderColor: '#2e3d58' }}>
        <p className="text-[10px] uppercase tracking-widest mb-2" style={{ color: '#627a9e' }}>Threat Level</p>
          ...
          return (
            ...
            >
              <span className="absolute inset-0 rounded-xl"
                style={{ background: active ? 'linear-gradient(90deg,rgba(77,148,255,0.18),rgba(184,128,255,0.08))' : 'transparent' }} />
              {!active && (
                <span className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-150"
                  style={{ background: 'rgba(46,61,88,0.5)' }} />
              )}
